      ...
      <div className={styles.faqWrapper}>
        ...
        {/* <div className={styles.contactSection}>
          ...
          <div className={styles.contactButtons}>
            ...
            <a href={`tel:${whatsAppNumber}`} className={styles.contactBtn}>
              <svg className={styles.btnIcon} viewBox="0 0 24 24" fill="none">
            ...
            <a href={`https://wa.me/${whatsAppNumber}`} target="_blank" rel="noopener noreferrer" className={styles.contactBtn}>
