...
interface Order {
  ...
  items_count: number;
  vendor_order_value: string;
  vendor_net_revenue: string;
  created_at: string;
}
            ...
            {orders.map((order) => (
              <tr key={order.id}>
                ...
                <td data-label="Order Value">
                  <strong>{formatCurrency(parseFloat(order.vendor_order_value || '0'))}</strong>
                </td>
                <td data-label="Net Revenue">
                  <strong className="tw-text-green-600">{formatCurrency(parseFloat(order.vendor_net_revenue || '0'))}</strong>
                </td>
