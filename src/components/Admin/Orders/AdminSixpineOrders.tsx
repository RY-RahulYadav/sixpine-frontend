...
const AdminSixpineOrders: React.FC = () => {
    ...
    const fetchOrders = async () => {
      try {
        ...
        const params: any = {
          ...
          date_from: dateFrom,
          date_to: dateTo,
          vendor: 'sixpine', // Filter for Sixpine orders only
        };
    ...
    <div className="admin-page">
      ...
      <div className="admin-page-header">
        <div className="admin-page-title">
          ...
          <div>
            <h1>Sixpine Order Management</h1>
            <p className="admin-page-subtitle">View and manage Sixpine brand orders and shipments</p>
          </div>
        </div>
      </div>
              ...
              <tr>
                <td colSpan={9} style={{ 
                  ...
                  <div style={{
                    ...
                    <h3 style={{ margin: '0 0 8px 0', textAlign: 'center', color: '#555' }}>No Sixpine orders found</h3>
                    <p style={{ margin: 0, textAlign: 'center', color: '#888' }}>Sixpine orders will appear here once customers make purchases</p>
                  </div>
                </td>
              </tr>
            )}
...
export default AdminSixpineOrders;
